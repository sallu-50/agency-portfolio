...
<section class="py-20 bg-blue-50" id="why-choose-us">
  ...
  <!-- conclusion section -->
  <section class="bg-gray-50 py-16 px-6 lg:px-24" id="conclusion">
    <div class="max-w-4xl mx-auto text-center">
      <h2 class="text-3xl font-bold text-gray-800 mb-6">Conclusion</h2>
      <p class="text-gray-700 text-lg leading-relaxed">
        Annotation Solution is your reliable partner in acquiring accurate, high-quality annotated data to fuel the success of your AI and machine learning projects. With a commitment to excellence and customer satisfaction, we are ready to assist you in turning your AI aspirations into reality. Let's embark on this journey together and unlock the full potential of AI technology!
      </p>
    </div>
  </section>
  <!-- contact section -->
  <section class="bg-white py-16 px-6 lg:px-24" id="contact">
    <div class="max-w-md mx-auto text-center">
      <h2 class="text-3xl font-bold text-gray-800 mb-6">Contact</h2>
      <p class="text-gray-700 text-lg font-semibold">Md Ebrahim Khalilullah</p>
      <p class="text-gray-600 mb-2">Project Manager</p>
      <p class="text-gray-600 mb-1">Annotation Solution</p>
      <p class="text-gray-600 mb-1">
        <strong>Email:</strong> <a href="mailto:ekdalim@gmail.com" class="text-blue-600 hover:underline">ekdalim@gmail.com</a>
      </p>
      <p class="text-gray-600">
        <strong>Phone:</strong> <a href="tel:+8801753499696" class="text-blue-600 hover:underline">+880 1753 499696</a>
      </p>
    </div>
  </section>
